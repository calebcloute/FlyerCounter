    ...
    var body: some View {
        Section {
            ...
            Text(
                ...
                "the last 2-second tick. Facing updates continuously; recent updates only on each tick. " +
                "Hold the phone upright in portrait with the top facing the direction you walk for best results."
            )
